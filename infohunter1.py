...
class InfoHunter(App):
    ...
    def _rebuild_table(self) -> None:
        ...
        # Preserve scroll position and cursor so refreshes don't jump to top
        saved_row    = tbl.cursor_row
        saved_scroll = tbl.scroll_y
